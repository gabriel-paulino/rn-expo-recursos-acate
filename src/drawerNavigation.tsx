...
import DragItems from "src/screens/dragEffects/";
import Breath from "src/screens/breathe/";
  ...
  return (
    <NavigationContainer>
      <Drawer.Navigator>
        ...
        <Drawer.Screen name="Drag Effects" component={DragItems} />
        <Drawer.Screen name="Breath Effect" component={Breath} />
      </Drawer.Navigator>
    </NavigationContainer>
  );
}
